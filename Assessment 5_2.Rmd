---
title: "Assessment 5_2"
author: "Pablo Alfonso García"
...
```{r Reading & Preprocessing,echo=TRUE}
# Download the file.
...
```{r Plot - Average number of steps per interval,echo=TRUE}
...
```{r Interval which contains the maximun number of steps in average,echo=TRUE}
...
```{r Histogram after filling NAs, echo=TRUE}
...
```{r Histogram (comparison), echo=TRUE}
