...
output: md_document #html_document for the HTML file
...
```{r Plot - Average number of steps per interval}
...
```{r Interval which contains the maximun number of steps in average}
